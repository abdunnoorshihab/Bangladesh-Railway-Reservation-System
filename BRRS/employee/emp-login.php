...
if(isset($_POST['emp_login']))
{
  ...
  $stmt=$mysqli->prepare("SELECT emp_email ,emp_pwd , emp_id FROM orrs_employee WHERE emp_email=? and emp_pwd=? ");
  $stmt->bind_param('ss',$emp_email,$emp_pwd);
  $stmt->execute();
  $stmt -> bind_result($emp_email,$emp_pwd,$emp_id);
  $rs=$stmt->fetch();
      ...
      <div class="main-content container-fluid">
        <div class="splash-container">
          <div class="card card-border-color card-border-color-success">
            <div class="card-header"><img class="logo-img" src="assets/img/logo-min.png" alt="logo" width="{conf.logoWidth}" height="100"><span class="splash-description">Please enter your user information.</span></div>
            <div class="card-body">
              <form method ="POST">
          ...
          <div class="splash-footer">Back <div class="home-emp"><a href="../index.php">Home</a></div></div>
